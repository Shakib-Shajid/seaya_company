    ...
    return (
        <div>
            <div className="p-5 md:p-10 lg:p-20 space-y-5">
                ...
                <p className="text-lg md:w-10/12 lg:w-full font-light pt-10 md:mx-auto hover:underline"><Link href="/impact"> <span>&minus;</span> Know more about our sustainability commitment</Link></p>
            </div>
